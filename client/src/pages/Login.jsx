      ...
      <div className="w-full max-w-md mx-4 animate-fade-in-up relative z-10">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 sm:p-10">
          ...
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-primary tracking-tight">Welcome Back</h3>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  name="password"
                  className="w-full pl-12 pr-12 py-3 rounded-xl sports-input text-sm"
                  placeholder="••••••••"
                  disabled={isLoading}
                />
                <button 
                  type="button"
                  className="absolute right-4 top-3.5 text-text-light hover:text-primary transition-colors"
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 cursor-pointer font-semibold text-text-light">
                <input type="checkbox" className="w-4 h-4 rounded text-secondary focus:ring-secondary border-gray-300" disabled={isLoading} />
                <span>Remember session</span>
              </label>
              <Link to="/forgot-password" className="text-secondary hover:text-blue-700 font-bold transition-colors">
                Forgot Password?
              </Link>
            </div>
